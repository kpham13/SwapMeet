...
//
// Uses code created by Trevor Harmon on 8/5/09.
// Free for personal or commercial use, with or without modification.
// No warranty is expressed or implied.

#import "UIImage+SwapMeet.h"

@implementation UIImage (SwapMeet)
...
- (UIImage *)thumbnailImage {
    return [self resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake(222, 222) interpolationQuality:kCGInterpolationHigh];
}
